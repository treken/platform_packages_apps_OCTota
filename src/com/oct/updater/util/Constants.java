...
import com.oct.updater.MainActivity;
import com.oct.updater.NotificationAlarm;
...
public class Constants {
    ...
    public static final String OVERLAY_GAPPS_URL = "ro.oct.gapps_url";
    public static final String OVERLAY_GAPPS_VERSION = "ro.oct.gapps_version";
    ...
    public static boolean isSystemApp(Context context) throws Exception {
        ...
        PackageInfo info = pm.getPackageInfo("com.oct.updater",
